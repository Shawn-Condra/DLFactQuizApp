...
//**************************************************************************************************
    public int sleepIsTheOnlyAnswer() {
    ...
    public void overWatchClick(View view) {
    ...
    public void heroAcadamia(View view) {
    ...
    public void strideRun(View view) {
    ...
    public void swordArtOnline(View view) {
